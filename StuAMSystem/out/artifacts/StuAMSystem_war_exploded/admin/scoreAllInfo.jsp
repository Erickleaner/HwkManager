...
function page(s){
  ...
  <form action="ServletSearchScore" method="post" id="frm">
    <div class="div_list">
   任务名：<input type="text" class="form-control form1"   name="cosName" value="${score.getCourseName() }" />&nbsp;&nbsp;&nbsp;&nbsp;
...
<%--					<a href="ServletDeleteScore?scoreID=${list.getScoreID() }" onclick="return confirm('是否确认删除？')">删除</a></td>--%>
